package com.wfz.shop.common.utils;
...
public class SliderImageUtil {
     ...
     */
    public static SliderImageCut pictureTemplatesCut(SerializableStream sliderFile, SerializableStream originalFile) throws Exception {
        ...
        SliderImageCut sliderImageCut = new SliderImageCut();

        sliderImageCut.setSlidingImage("data:image/png;base64," + Base64Utils.encodeToString(newImagery));
        sliderImageCut.setBackImage("data:image/png;base64," + Base64Utils.encodeToString(oriImageByte));
//       x轴
        sliderImageCut.setRandomX(randomX);
//       y轴
        sliderImageCut.setRandomY(randomY);

        sliderImageCut.setOriginalHeight(originalHeight);
        sliderImageCut.setOriginalWidth(originalWidth);
        sliderImageCut.setSliderHeight(sliderHeight);
        sliderImageCut.setSliderWidth(sliderWidth);
        return sliderImageCut;
    }
